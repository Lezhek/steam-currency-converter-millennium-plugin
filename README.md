...
![Главная страница магазина | Store home page](assets/1.png)

![Список игр и карточка товара | Game list and product card](assets/2.png)

### Steam Community Market

![Список лотов и история сделок | Listings and transaction history](assets/3.png)
